#ifndef RSServerOptionsH
#define RSServerOptionsH
// =============================================================================
...
class CRSServerOptions : public CSimpleOptions {
public:
    // constructor - tune option setup
    CRSServerOptions(void);
...
// program name and description -----------------------------------------------
    ...
    CSO_PROG_DESC_BEGIN
    "result-server collects data sent by result-client."
    CSO_PROG_DESC_END
...
// description of options -----------------------------------------------------
    CSO_MAP_OPT(bool,                           /* option type */
                DoNotShutdown,                        /* option name */
                false,                          /* default value */
                false,                          /* is option mandatory */
                '\0',                           /* short option name */
                "donotshutdown",                      /* long option name */
                NULL,                           /* parametr name */
