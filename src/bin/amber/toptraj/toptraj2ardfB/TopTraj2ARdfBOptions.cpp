...
#include "TopTraj2ARdfBOptions.hpp"
...
CTopTraj2ARdfBOptions::CTopTraj2ARdfBOptions(void)
{
...
int CTopTraj2ARdfBOptions::CheckOptions(void)
{
...
int CTopTraj2ARdfBOptions::FinalizeOptions(void)
{
    bool ret_opt = false;
...
int CTopTraj2ARdfBOptions::CheckArguments(void)
{
    return(SO_CONTINUE);
}
