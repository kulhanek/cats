#ifndef TopTraj2ARdfBOptionsH
#define TopTraj2ARdfBOptionsH
// =============================================================================
...
class CTopTraj2ARdfBOptions : public CSimpleOptions {
public:
    // constructor - tune option setup
    CTopTraj2ARdfBOptions(void);
...
// program name and description -----------------------------------------------
    ...
    CSO_PROG_DESC_BEGIN
    "<red>toptra2ardfB</red> calculates angular radial distribution function g(<u>r</u>,<u>a</u>). A distance <u>r</u> is calculated "
    "between <u>SOLUTE</u> and <u>SOLVENT</u> residue centers of masses. An angle <u>a</u> is calculated between "
    "a normal vector of best fit plane of <u>SOLUTE</u> residue and a normal vector of best fit plane of <u>SOLVENT</u> residue."
    CSO_PROG_DESC_END
