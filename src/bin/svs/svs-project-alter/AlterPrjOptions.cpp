...
CAlterPrjOptions::CAlterPrjOptions(void)
{
...
int CAlterPrjOptions::CheckOptions(void)
{
    return(SO_CONTINUE);
}
...
int CAlterPrjOptions::FinalizeOptions(void)
{
    bool ret_opt = false;
...
int CAlterPrjOptions::CheckArguments(void)
{
