#ifndef VSServerOptionsH
#define VSServerOptionsH
// =============================================================================
...
class CVSServerOptions : public CSimpleOptions {
public:
    // constructor - tune option setup
    CVSServerOptions(void);
...
// description of arguments ---------------------------------------------------
    CSO_MAP_ARG(CSmallString,                   /* argument type */
                ...
                "name of control file or - for data from the standard input")   /* argument description */
