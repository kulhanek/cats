...
// description of arguments ---------------------------------------------------
    ...
    CSO_MAP_ARG(CSmallString,                   /* argument type */
                ...
                "   addindx     = add primary index to ID column\n"
                "   removeindx  = remove primary index from ID solumn\n"
                "   rebuildindx = removeindx + addindx\n"
                "   deleteall   = delete all records from project database\n"
                "   addres      = add aditional result column\n"
                "   rmres       = remove last result column\n"
                "   operator    = alter project operator by value\n"
                "   description = alter project description by value\n"
...
// description of options -----------------------------------------------------
    CSO_MAP_OPT(CSmallString,                           /* option type */
                ...
                "TEXT",                           /* parametr name */
                "value used by commands operator and description")   /* option description */
    //----------------------------------------------------------------------
