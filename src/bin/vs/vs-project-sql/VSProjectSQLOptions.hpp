...
// program name and description -----------------------------------------------
    ...
    "The input file can be processed either by openbalel (<i>auto</i> or user specified input format) or "
    "by a special parser in the case of <i>ssmi</i> (stream SMILE file). The format <i>ssmi</i> contains two entries on every line. "
